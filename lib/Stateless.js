...
// ranked in order of the number of likes
// Messages are returned in groups of 20, ordered by created_at descending
//   id [required]  - group_id string
//   period         - string — one of: 'day', 'week', or 'month'
api.Leaderboard.index = function(at, id, period, callback) {
  getRequest(at, "/groups/" + id + "/likes" + period, {opts:{period: period}, doParse:true}, callback);  
}
